...
public class BlockChest extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving)
    {
        ...
        logger.info("Chest placed in world - " + par1World.worldInfo.func_76065_j() +" ("+par1World.worldInfo.getDimension()+") at [x:" + par2 + ", y:" + par3 + ", z:" + par4 + "] By <" + par5EntityLiving.getEntityName() + ">");
...
//chest gets destroyed - dropping items?
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
        	logger.info("<" + par5EntityPlayer.username + "> in world - "+par1World.worldInfo.func_76065_j()+" ("+par5EntityPlayer.dimension+") at [x:"+par5EntityPlayer.posX+", y:"+par5EntityPlayer.posY+", z:"+par5EntityPlayer.posZ+"] Opened the chest in world " + par1World.worldInfo.func_76065_j() + " at [x:" + par2 + ", y:" + par3 + ", z:" + par4 + "]");
